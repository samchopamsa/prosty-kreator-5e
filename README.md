...
Wykrywanie jest **wstrzymane w trakcie importu** — od naciśnięcia przycisku aż do
sygnału `Import Complete`, na wszystkich ścieżkach, także przy dodawaniu drugiej klasy
