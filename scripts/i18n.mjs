...
const STRINGS = {
  en: {
    ...
    "levelup.targetOption": "Level {0} ({1} to gain)",
    "levelup.start": "Level up",
    "levelup.working": "Working...",
    "levelup.waiting": "Waiting for the importer to finish. Work through its windows and close the last one.",
    "levelup.progress": "Level {0} of {1}",
    "levelup.gained": "What you gained",
    ...
    "levelup.notes": "Worth checking",
    "check.ruleMissing": "{0}: not on the sheet",
    "check.ruleMissingHint": "The rules grant this at {0} level {1}, but nothing by that name is here.",
    "check.ruleChoice": "{0}: not finished",
    "check.ruleChoiceHint": "{0} of {1} chosen.",
    "check.ruleOk": "Features match the rules",
    "check.ruleOkHint": "Checked every level up to this one ({0} in total).",
    "preview.choose": "choose {0}",
  ...
  pl: {
    ...
    "levelup.targetOption": "Poziom {0} (do zdobycia: {1})",
    "levelup.start": "Awansuj",
    "levelup.working": "Trwa...",
    "levelup.waiting": "Czekam, aż importer skończy. Przejdź przez jego okna i zamknij ostatnie.",
    "levelup.progress": "Poziom {0} z {1}",
    "levelup.gained": "Co przybyło",
    ...
    "levelup.notes": "Warto sprawdzić",
    "check.ruleMissing": "{0}: nie ma na karcie",
    "check.ruleMissingHint": "Reguły dają to na {1}. poziomie klasy {0}, a pozycji o tej nazwie tu nie ma.",
    "check.ruleChoice": "{0}: wybór niedokończony",
    "check.ruleChoiceHint": "Wybrano {0} z {1}.",
    "check.ruleOk": "Cechy zgadzają się z regułami",
    "check.ruleOkHint": "Sprawdzono każdy poziom do obecnego (razem {0}).",
    "preview.choose": "wybierz {0}",
