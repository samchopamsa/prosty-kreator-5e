...
const STRINGS = {
  en: {
    ...
    "portrait.urlNote": "An address ending in .png, .jpg or .webp. The picture is copied into your world where the site allows it, so it keeps working if that page later disappears.",
    "portrait.keptAsLink": "The picture could not be copied, so it stays a link. It will show on the sheet; the token may not, and it disappears if that page does.",
  ...
  pl: {
    ...
    "portrait.urlNote": "Adres kończący się na .png, .jpg albo .webp. Obrazek zostanie skopiowany do twojego świata, o ile strona na to pozwala — wtedy działa dalej, nawet gdy ta strona zniknie.",
    "portrait.keptAsLink": "Nie udało się skopiować obrazka, więc zostaje odnośnikiem. Na karcie będzie widoczny; token może nie być, a wszystko zniknie razem z tamtą stroną.",
