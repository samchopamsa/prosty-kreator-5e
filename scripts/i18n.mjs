...
const STRINGS = {
  en: {
    ...
    "levelup.noButton": "Could not find the level-up button on the sheet. Open the sheet and try from there.",
    "levelup.nothingChanged": "Nothing changed on the character. The import may have been cancelled.",
  ...
  pl: {
    ...
    "levelup.noButton": "Nie znalazłem przycisku awansu na karcie. Otwórz kartę i spróbuj stamtąd.",
    "levelup.nothingChanged": "Nic się nie zmieniło na postaci. Import mógł zostać anulowany.",
