...
const STRINGS = {
  en: {
    ...
    "portrait.fromDisk": "A picture from this computer",
    "portrait.folderNote": "It is uploaded to {0} and used straight away.",
    "portrait.noUpload": "You cannot upload files in this world, so use a link below. Ask your GM if you would rather upload a picture.",
    "portrait.fromWeb": "Or a link to a picture",
    "portrait.urlNote": "An address ending in .png, .jpg or .webp. The picture stays where it is - if that page disappears, so does the portrait.",
    "portrait.set": "Set portrait",
    "portrait.cancel": "Cancel",
    "step.bio": "Bio",
    "stepAcc.bio": "bio",
    "blurb.bio":
    ...
    "gains.features.class": "Class features",
    "gains.features.species": "Species traits",
    "gains.features.background": "Background features",
    "gains.stats": "Statistics",
    "gains.proficiencies": "Proficiencies",
    "gains.languages": "Languages",
    "gains.features": "Features",
    "gains.spells": "Spells",
    "gains.gear": "Equipment",
    "gains.other": "Other",
    "gains.hp": "Hit points",
    "gains.speed": "Speed",
    "gains.size": "Size",
    ...
    "panel.missingOnly": "\"{0}\" is not in the available compendiums. Pick something below to read instead.",
    ...
    "guide.reportBlurb": "Everything the panel can check, in one place. Each finding is also shown on the step that can fix it.",
    ...
    "picker.empty": "Hover an entry to read what it does.",
    "picker.unknown": "No description found for {0}.",
    "picker.subclassOf": "{0} subclass",
    "picker.atLevel": "At level {0}",
    "picker.hitDie": "Hit die {0}",
    "picker.primary": "Primary ability: {0}",
    "picker.equipment": "Starting equipment",
    "text.level": "Level",
    "text.proficiency": "Prof.",
    "text.features": "Features",
    "text.atLevel": "Level {0}",
    "text.subclassOf": "{0} subclass · {1}",
    "text.hitDie": "Hit die {0}",
    "text.primary": "Primary: {0}",
    ...
    "check.spellCount": "{0} {1}: spells to pick",
    "check.spellPart": "{0}: {1} of {2}.",
    "check.cantripPart": "Cantrips: {0} of {1}.",
    "check.spellTrailer": "The importer does not choose this class's spells - add what is missing from its spell list.",
    "check.addSpells": "Add spells",
    "check.spellLevels": "Spell levels up to {0}.",
    "text.spellsHead": "Spells to pick at level {0}",
    "text.spellsAt": "{0}: {1}.",
    "text.spellsOf": "{0}: {1} of {2} on the sheet.",
    "text.cantripsAt": "Cantrips: {0}.",
    "text.cantripsOf": "Cantrips: {0} of {1} on the sheet.",
    "text.spellsNote": "The importer does not choose this class's spells - once the class is in, the panel offers an \"Add spells\" button that opens the importer's spell list.",
    "spellpanel.title": "Spells on the sheet",
    "spellpanel.remove": "Remove",
    "spellpanel.empty": "No spells on the sheet yet. Tick spells in the list and press Import.",
    "spellpanel.cantrips": "Cantrips",
    "spellpanel.level": "Level {0}",
    "spellpanel.removeFailed": "Could not remove {0}: {1}",
    "check.spellHigh": "{0} {1}: spells above the class's level",
    "check.spellHighLine": "Above what the class casts at this level (up to level {1}): {0}. Remove them or swap them for spells the class can cast.",
    "check.changeSpells": "Change spells",
    "guide.spellsLink": "Spells",
    "spellpanel.tooHigh": "Above what the class can cast at this level.",
    "spellpanel.tooHighTitle": "Spells above the class's level",
    "spellpanel.tooHighIntro": "A {0} of this level casts spells up to level {1}. These just imported are higher:",
    "spellpanel.tooHighOutro": "They stay on the sheet; remove them from the panel beside the list, or swap them for spells the class can cast.",
    "spellpanel.levelOf": "level {0}",
    "spellpanel.origin.race": "Species",
    "spellpanel.origin.species": "Species",
    "spellpanel.origin.background": "Background",
    "spellpanel.origin.feat": "Feat",
    "spellpanel.origin.subclass": "Subclass",
    "spellpanel.origin.innate": "Innate",
    "spellpanel.origin.atwill": "At will",
    "spellpanel.origin.consumable": "Item",
    "spellpanel.origin.other": "Granted",
    "spells.kind.known": "Spells known",
    "spells.kind.prepared": "Prepared spells",
    "spells.kind.spellbook": "Spells in the spellbook",
    "spells.noImporter": "The importer's spell list is not available - it opens only while the importer is active.",
    "spells.openFailed": "The importer would not open its spell list: {0}",
    ...
    "review.submit": "Send to the GM",
    "review.submitWithProblems": "Send to the GM ({0} to fix)",
    "review.notYet": "Not sent to the GM yet.",
    "review.pending": "Waiting for the GM since {0}.",
    "review.approved": "Approved by the GM on {0}.",
    "review.returned": "Sent back by the GM on {0}.",
    "review.note": "From the GM: {0}",
    "review.cardTitle": "Sent for approval",
    "review.skipped": "Skipped inside the importer",
    "review.findings": "Worth a look",
    "review.gains": "What arrived during creation",
    "review.noFindings": "Nothing to report - every check passed.",
    "review.rulesUnavailable": "The comparison against the rules did not run: the importer's rules data was not loaded, so class features were not checked at all.",
    "review.approve": "Approve",
    "review.sendBack": "Send back",
    "review.notePrompt": "What should be changed?",
    "review.sentToast": "Sent to the GM.",
    "review.failed": "Could not send the character to the GM. {0}",
    "review.noGm": "There is no GM in this world to send the character to.",
    "review.approvedToast": "Character approved.",
    "review.returnedToast": "Character sent back to the player.",
    "review.alreadyApproved": "Already approved.",
    "review.alreadyReturned": "Already sent back.",
    "review.superseded": "Sent again since - the newer card is further down.",
    "review.dirFilter": "{0} waiting for you - show only these",
    "review.dirFilterOff": "Showing only what is waiting - show everyone again",
    "review.gone": "That character no longer exists.",
    "review.decisionApproved": "{0} - approved.",
    "review.decisionReturned": "{0} - sent back for changes.",
    "check.spells": "Spells on the sheet",
    "check.spellsHint": "This character has spell slots but nothing to cast. For a Bard, Sorcerer, Warlock or Wizard the importer does not pick spells at all - they have to be added from its spell list.",
  ...
  pl: {
    ...
    "portrait.title": "Portret",
    "portrait.fromDisk": "Obrazek z tego komputera",
    "portrait.folderNote": "Trafi do {0} i od razu zostanie ustawiony.",
    "portrait.noUpload": "Nie masz w tym świecie prawa wgrywania plików, więc skorzystaj z odnośnika poniżej. Jeśli wolisz wgrać obrazek, poproś MG.",
    "portrait.fromWeb": "Albo odnosnik do obrazka",
    "portrait.urlNote": "Adres kończący się na .png, .jpg albo .webp. Obrazek zostaje tam, gdzie jest — jeśli ta strona zniknie, zniknie i portret.",
    "portrait.set": "Ustaw portret",
    "portrait.cancel": "Anuluj",
    "step.bio": "Bio",
    "stepAcc.bio": "bio",
    "blurb.bio":
    ...
    "gains.features.class": "Cechy klasy",
    "gains.features.species": "Cechy gatunku",
    "gains.features.background": "Cechy pochodzenia",
    "gains.stats": "Statystyki",
    "gains.proficiencies": "Biegłości",
    "gains.languages": "Języki",
    "gains.features": "Cechy",
    "gains.spells": "Zaklęcia",
    "gains.gear": "Ekwipunek",
    "gains.other": "Pozostałe",
    "gains.hp": "Punkty życia",
    "gains.speed": "Szybkość",
    "gains.size": "Rozmiar",
    ...
    "bio.skin": "Skóra",
    "bio.faith": "Wiara",
    "bio.alignment": "Charakter",
    "bio.trait": "Cechy charakteru",
    "bio.ideal": "Ideały",
    "bio.bond": "Więzi",
    "bio.flaw": "Słabości",
    "bio.appearance": "Wygląd",
    ...
    "panel.missingOnly": "Nie ma \"{0}\" w dostępnych kompendiach. Wybierz poniżej, co przeczytać zamiast tego.",
    "guide.levelUp": "Dodaj poziom lub kolejną klasę",
    "guide.ready": "Gotowa do gry",
    "guide.toFix": "Do poprawienia: {0}",
    "guide.reportBlurb": "Wszystko, co panel potrafi sprawdzić, w jednym miejscu. Każda uwaga pokazuje się też przy kroku, który ją naprawia.",
    ...
    "picker.empty": "Najedź na pozycję, żeby przeczytać, co daje.",
    "picker.unknown": "Nie znaleziono opisu dla: {0}.",
    "picker.subclassOf": "Podklasa klasy {0}",
    "picker.atLevel": "Na {0}. poziomie",
    "picker.hitDie": "Kość życia {0}",
    "picker.primary": "Główna cecha: {0}",
    "picker.equipment": "Ekwipunek startowy",
    "text.level": "Poziom",
    "text.proficiency": "Biegłość",
    "text.features": "Cechy",
    "text.atLevel": "Poziom {0}",
    "text.subclassOf": "Podklasa klasy {0} · {1}",
    "text.hitDie": "Kość życia {0}",
    "text.primary": "Główna cecha: {0}",
    ...
    "check.spellCount": "{0} {1}: zaklęcia do wybrania",
    "check.spellPart": "{0}: {1} z {2}.",
    "check.cantripPart": "Sztuczki: {0} z {1}.",
    "check.spellTrailer": "Importer sam nie dobiera zaklęć tej klasy - brakujące dodaj z jego listy zaklęć.",
    "check.addSpells": "Dodaj zaklęcia",
    "check.spellLevels": "Zaklęcia do {0}. poziomu.",
    "text.spellsHead": "Zaklęcia do wybrania na {0}. poziomie",
    "text.spellsAt": "{0}: {1}.",
    "text.spellsOf": "{0}: {1} z {2} na karcie.",
    "text.cantripsAt": "Sztuczki: {0}.",
    "text.cantripsOf": "Sztuczki: {0} z {1} na karcie.",
    "text.spellsNote": "Importer sam nie dobiera zaklęć tej klasy - gdy klasa już będzie na karcie, panel pokaże przycisk „Dodaj zaklęcia”, który otwiera listę zaklęć importera.",
    "spellpanel.title": "Zaklęcia na karcie",
    "spellpanel.remove": "Usuń",
    "spellpanel.empty": "Na karcie nie ma jeszcze zaklęć. Zaznacz je na liście i naciśnij Import.",
    "spellpanel.cantrips": "Sztuczki",
    "spellpanel.level": "Poziom {0}",
    "spellpanel.removeFailed": "Nie udało się usunąć {0}: {1}",
    "check.spellHigh": "{0} {1}: zaklęcia powyżej poziomu klasy",
    "check.spellHighLine": "Powyżej tego, co klasa rzuca na tym poziomie (do {1}. poziomu): {0}. Usuń je albo zamień na zaklęcia, które klasa może rzucić.",
    "check.changeSpells": "Zmień zaklęcia",
    "guide.spellsLink": "Zaklęcia",
    "spellpanel.tooHigh": "Powyżej tego, co klasa może rzucić na tym poziomie.",
    "spellpanel.tooHighTitle": "Zaklęcia powyżej poziomu klasy",
    "spellpanel.tooHighIntro": "{0} na tym poziomie rzuca zaklęcia do {1}. poziomu. Te właśnie zaimportowane są wyższe:",
    "spellpanel.tooHighOutro": "Zostają na karcie; usuń je w panelu obok listy albo zamień na zaklęcia, które klasa może rzucić.",
    "spellpanel.levelOf": "poziom {0}",
    "spellpanel.origin.race": "Rasa",
    "spellpanel.origin.species": "Rasa",
    "spellpanel.origin.background": "Pochodzenie",
    "spellpanel.origin.feat": "Atut",
    "spellpanel.origin.subclass": "Podklasa",
    "spellpanel.origin.innate": "Wrodzone",
    "spellpanel.origin.atwill": "Dowolnie",
    "spellpanel.origin.consumable": "Przedmiot",
    "spellpanel.origin.other": "Nadane",
    "spells.kind.known": "Zaklęcia znane",
    "spells.kind.prepared": "Zaklęcia przygotowane",
    "spells.kind.spellbook": "Zaklęcia w księdze",
    "spells.noImporter": "Lista zaklęć importera jest niedostępna - otwiera się tylko, gdy importer jest aktywny.",
    "spells.openFailed": "Importer nie otworzył listy zaklęć: {0}",
    ...
    "review.submit": "Zgłoś do MG",
    "review.submitWithProblems": "Zgłoś do MG ({0} do poprawki)",
    "review.notYet": "Postać nie została jeszcze zgłoszona.",
    "review.pending": "Czeka na MG od {0}.",
    "review.approved": "Zatwierdzona przez MG {0}.",
    "review.returned": "Odesłana przez MG {0}.",
    "review.note": "Uwagi MG: {0}",
    "review.cardTitle": "Zgłoszenie do akceptacji",
    "review.skipped": "Pominięte w importerze",
    "review.findings": "Do sprawdzenia",
    "review.gains": "Co przyszło przy tworzeniu",
    "review.noFindings": "Nic do zgłoszenia - wszystkie sprawdzenia wypadły dobrze.",
    "review.rulesUnavailable": "Porównanie z regułami nie zostało wykonane: dane reguł importera nie były wczytane, więc zdolności klasowe nie zostały sprawdzone w ogóle.",
    "review.approve": "Zatwierdź",
    "review.sendBack": "Odeślij",
    "review.notePrompt": "Co poprawić?",
    "review.sentToast": "Zgłoszono do MG.",
    "review.failed": "Nie udało się zgłosić postaci do MG. {0}",
    "review.noGm": "W tym świecie nie ma MG, do którego można zgłosić postać.",
    "review.approvedToast": "Postać zatwierdzona.",
    "review.returnedToast": "Postać odesłana do gracza.",
    "review.alreadyApproved": "Już zatwierdzona.",
    "review.alreadyReturned": "Już odesłana.",
    "review.superseded": "Zgłoszona ponownie — nowsza karta jest niżej.",
    "review.dirFilter": "Czeka na Ciebie: {0} — pokaż tylko te",
    "review.dirFilterOff": "Widać tylko oczekujące — pokaż wszystkie",
    "review.gone": "Ta postać już nie istnieje.",
    "review.decisionApproved": "{0} - zatwierdzona.",
    "review.decisionReturned": "{0} - do poprawki.",
    "check.spells": "Zaklęcia na karcie",
    "check.spellsHint": "Ta postać ma komórki zaklęć, ale nie ma czego rzucać. Bardowi, czarownikowi, warlockowi i magowi importer w ogóle nie dobiera zaklęć - trzeba je dodać z jego listy zaklęć.",
